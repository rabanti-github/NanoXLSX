...
namespace Demo
{
    class Program
    {
        ...
        private static void Demo12()
        {
            ...
            wb.CurrentWorksheet.SetColumnWidth(0, 15f);
            wb.CurrentWorksheet.SetColumnWidth(1, 20f);
            wb.CurrentWorksheet.SetColumnWidth(2, 35f);
            ...
            wb.CurrentWorksheet.SetRowHeight(0, 10f);
            wb.CurrentWorksheet.SetRowHeight(3, 15f);
            wb.CurrentWorksheet.SetRowHeight(2, 25f);
        ...
        private static void Demo13()
        {
            ...
            Workbook wb2 = new Workbook("demo13(hidden:worksheet).xlsx", "visible");       // Create a new workbook
            wb2.CurrentWorksheet.AddNextCell("Visible Worksheet");
            wb.AddWorksheet("hidden");                                                     // Create new worksheet
            wb.CurrentWorksheet.AddNextCell("Hidden Worksheet");
            wb.CurrentWorksheet.Hidden = true;                                             // Set the current worksheet hidden
