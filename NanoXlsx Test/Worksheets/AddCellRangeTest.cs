...
namespace NanoXLSX_Test.Worksheets
{
    public class AddCellRangeTest
    {
        ...
        [Theory(DisplayName = "Test of the AddCellRange function for a random list with start and end address")]
        ...
        public void AddCellRangeTest1(int startColumn, int startRow, RangeType type)
        {
            ListTuple data = GetRandomList(startColumn, startRow, type);
        ...
        [Theory(DisplayName = "Test of the AddCellRange function for a random list with start and end address and a style")]
        [InlineData(0, 0, RangeType.OneColumn)]
        [InlineData(7, 27, RangeType.OneRow)]
        [InlineData(5, 13, RangeType.FourColumnsThreeRows)]
        [InlineData(22, 11, RangeType.ThreeColumnsFourRows)]
        public void AddCellRangeTest2(int startColumn, int startRow, RangeType type)
        {
            ListTuple data = GetRandomList(startColumn, startRow, type);
            Worksheet worksheet = new Worksheet();
            Address startAddress = new Address(startColumn, startRow);
        ...
        [Theory(DisplayName = "Test of the AddCellRange function for a random list with start and end address and a active style on the workbook")]
        [InlineData(0, 0, RangeType.OneColumn)]
        [InlineData(7, 27, RangeType.OneRow)]
        [InlineData(5, 13, RangeType.FourColumnsThreeRows)]
        [InlineData(22, 11, RangeType.ThreeColumnsFourRows)]
        public void AddCellRangeTest3(int startColumn, int startRow, RangeType type)
        {
            ListTuple data = GetRandomList(startColumn, startRow, type);
            Worksheet worksheet = new Worksheet();
        ...
        [Theory(DisplayName = "Test of the AddCellRange function for a random list with a range as string")]
        [InlineData("A1:A12", RangeType.OneColumn)]
        [InlineData("H28:S28", RangeType.OneRow)]
        [InlineData("F14:I16", RangeType.FourColumnsThreeRows)]
        [InlineData("T12:V15", RangeType.ThreeColumnsFourRows)]
        public void AddCellRangeTest4(String range, RangeType type)
        {
        ...
        [Theory(DisplayName = "Test of the AddCellRange function for a random list with a range as string and a style")]
        [InlineData("A1:A12", RangeType.OneColumn)]
        [InlineData("H28:S28", RangeType.OneRow)]
        [InlineData("F14:I16", RangeType.FourColumnsThreeRows)]
        [InlineData("T12:V15", RangeType.ThreeColumnsFourRows)]
        public void AddCellRangeTest5(String range, RangeType type)
        {
            NanoXLSX.Range cellRange = Cell.ResolveCellRange(range);
            ListTuple data = GetRandomList(cellRange.StartAddress.Column, cellRange.StartAddress.Row, type);
            Worksheet worksheet = new Worksheet();
        ...
        [Theory(DisplayName = "Test of the AddCellRange function for a random list with a range as string and an active style on the worksheet")]
        [InlineData("A1:A12", RangeType.OneColumn)]
        [InlineData("H28:S28", RangeType.OneRow)]
        [InlineData("F14:I16", RangeType.FourColumnsThreeRows)]
        [InlineData("T12:V15", RangeType.ThreeColumnsFourRows)]
        public void AddCellRangeTest6(String range, RangeType type)
        {
            NanoXLSX.Range cellRange = Cell.ResolveCellRange(range);
            ListTuple data = GetRandomList(cellRange.StartAddress.Column, cellRange.StartAddress.Row, type);
            Worksheet worksheet = new Worksheet();
