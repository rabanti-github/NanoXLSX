...
namespace NanoXLSX.LowLevel
{
    ...
    partial class LowLevel
    {
        ...
        {
            Style.Style.Border[] borderStyles = this.workbook.Styles.GetBorders();
            StringBuilder sb = new StringBuilder();
            foreach (Style.Style.Border item in borderStyles)
            {
                ...
                if (item.LeftStyle != Style.Style.Border.StyleValue.none)
                {
                    sb.Append("<left style=\"" + Style.Style.Border.GetStyleName(item.LeftStyle) + "\">");
                ...
                if (item.RightStyle != Style.Style.Border.StyleValue.none)
                {
                    sb.Append("<right style=\"").Append(Style.Style.Border.GetStyleName(item.RightStyle)).Append("\">");
                ...
                if (item.TopStyle != Style.Style.Border.StyleValue.none)
                {
                    sb.Append("<top style=\"").Append(Style.Style.Border.GetStyleName(item.TopStyle)).Append("\">");
                ...
                if (item.BottomStyle != Style.Style.Border.StyleValue.none)
                {
                    sb.Append("<bottom style=\"").Append(Style.Style.Border.GetStyleName(item.BottomStyle)).Append("\">");
                ...
                if (item.DiagonalStyle != Style.Style.Border.StyleValue.none)
                {
                    sb.Append("<diagonal style=\"").Append(Style.Style.Border.GetStyleName(item.DiagonalStyle)).Append("\">");
        ...
        {
            Style.Style.Font[] fontStyles = this.workbook.Styles.GetFonts();
            StringBuilder sb = new StringBuilder();
            foreach (Style.Style.Font item in fontStyles)
            {
                sb.Append("<font>");
                ...
                if (item.VerticalAlign == Style.Style.Font.VerticalAlignValue.subscript) { sb.Append("<vertAlign val=\"subscript\"/>"); }
                else if (item.VerticalAlign == Style.Style.Font.VerticalAlignValue.superscript) { sb.Append("<vertAlign val=\"superscript\"/>"); }
                ...
                if (item.Scheme != Style.Style.Font.SchemeValue.none)
                {
                    if (item.Scheme == Style.Style.Font.SchemeValue.major)
                    { sb.Append("<scheme val=\"major\"/>"); }
                    else if (item.Scheme == Style.Style.Font.SchemeValue.minor)
        ...
        {
            Style.Style.Fill[] fillStyles = this.workbook.Styles.GetFills();
            StringBuilder sb = new StringBuilder();
            foreach (Style.Style.Fill item in fillStyles)
            {
                sb.Append("<fill>");
                sb.Append("<patternFill patternType=\"").Append(Style.Style.Fill.GetPatternName(item.PatternFill)).Append("\"");
                if (item.PatternFill == Style.Style.Fill.PatternValue.solid)
                {
                    sb.Append(">");
                ...
                else if (item.PatternFill == Style.Style.Fill.PatternValue.mediumGray || item.PatternFill == Style.Style.Fill.PatternValue.lightGray || item.PatternFill == Style.Style.Fill.PatternValue.gray0625 || item.PatternFill == Style.Style.Fill.PatternValue.darkGray)
                {
                    sb.Append(">");
                    sb.Append("<fgColor rgb=\"").Append(item.ForegroundColor).Append("\"/>");
        ...
        {
            Style.Style.NumberFormat[] numberFormatStyles = this.workbook.Styles.GetNumberFormats();
            StringBuilder sb = new StringBuilder();
            foreach (Style.Style.NumberFormat item in numberFormatStyles)
            {
        ...
        {
            Style.Style[] styles = this.workbook.Styles.GetStyles();
            StringBuilder sb = new StringBuilder();
            StringBuilder sb2 = new StringBuilder();
            string alignmentString, protectionString;
            int formatNumber, textRotation;
            foreach (Style.Style item in styles)
            {
                textRotation = item.CurrentCellXf.CalculateInternalRotation();
                alignmentString = string.Empty;
                protectionString = string.Empty;
                if (item.CurrentCellXf.HorizontalAlign != Style.Style.CellXf.HorizontalAlignValue.none || item.CurrentCellXf.VerticalAlign != Style.Style.CellXf.VerticalAlignValue.none || item.CurrentCellXf.Alignment != Style.Style.CellXf.TextBreakValue.none || textRotation != 0)
                {
                    sb2.Clear();
                    sb2.Append("<alignment");
                    if (item.CurrentCellXf.HorizontalAlign != Style.Style.CellXf.HorizontalAlignValue.none)
                    {
                        sb2.Append(" horizontal=\"");
                        if (item.CurrentCellXf.HorizontalAlign == Style.Style.CellXf.HorizontalAlignValue.center) { sb2.Append("center"); }
                        else if (item.CurrentCellXf.HorizontalAlign == Style.Style.CellXf.HorizontalAlignValue.right) { sb2.Append("right"); }
                        else if (item.CurrentCellXf.HorizontalAlign == Style.Style.CellXf.HorizontalAlignValue.centerContinuous) { sb2.Append("centerContinuous"); }
                        else if (item.CurrentCellXf.HorizontalAlign == Style.Style.CellXf.HorizontalAlignValue.distributed) { sb2.Append("distributed"); }
                        else if (item.CurrentCellXf.HorizontalAlign == Style.Style.CellXf.HorizontalAlignValue.fill) { sb2.Append("fill"); }
                        else if (item.CurrentCellXf.HorizontalAlign == Style.Style.CellXf.HorizontalAlignValue.general) { sb2.Append("general"); }
                        else if (item.CurrentCellXf.HorizontalAlign == Style.Style.CellXf.HorizontalAlignValue.justify) { sb2.Append("justify"); }
                        else { sb2.Append("left"); }
                        sb2.Append("\"");
                    }
                    if (item.CurrentCellXf.VerticalAlign != Style.Style.CellXf.VerticalAlignValue.none)
                    {
                        sb2.Append(" vertical=\"");
                        if (item.CurrentCellXf.VerticalAlign == Style.Style.CellXf.VerticalAlignValue.center) { sb2.Append("center"); }
                        else if (item.CurrentCellXf.VerticalAlign == Style.Style.CellXf.VerticalAlignValue.distributed) { sb2.Append("distributed"); }
                        else if (item.CurrentCellXf.VerticalAlign == Style.Style.CellXf.VerticalAlignValue.justify) { sb2.Append("justify"); }
                        else if (item.CurrentCellXf.VerticalAlign == Style.Style.CellXf.VerticalAlignValue.top) { sb2.Append("top"); }
                        else { sb2.Append("bottom"); }
                        sb2.Append("\"");
                    }

                    if (item.CurrentCellXf.Alignment != Style.Style.CellXf.TextBreakValue.none)
                    {
                        if (item.CurrentCellXf.Alignment == Style.Style.CellXf.TextBreakValue.shrinkToFit) { sb2.Append(" shrinkToFit=\"1"); }
                ...
                if (item.CurrentFill.PatternFill != Style.Style.Fill.PatternValue.none)
                {
                ...
                if (item.CurrentNumberFormat.Number != Style.Style.NumberFormat.FormatNumber.none)
                {
        ...
        {
            Style.Style.Font[] fonts = this.workbook.Styles.GetFonts();
            Style.Style.Fill[] fills = this.workbook.Styles.GetFills();
            StringBuilder sb = new StringBuilder();
            List<string> tempColors = new List<string>();
            foreach (Style.Style.Font item in fonts)
            {
                if (string.IsNullOrEmpty(item.ColorValue) == true) { continue; }
                if (item.ColorValue == Style.Style.Fill.DEFAULTCOLOR) { continue; }
                if (tempColors.Contains(item.ColorValue) == false) { tempColors.Add(item.ColorValue); }
            }
            foreach (Style.Style.Fill item in fills)
            {
                if (string.IsNullOrEmpty(item.BackgroundColor) == false)
                {
                    if (item.BackgroundColor != Style.Style.Fill.DEFAULTCOLOR)
                    {
                ...
                {
                    if (item.ForegroundColor != Style.Style.Fill.DEFAULTCOLOR)
                    {
