...
namespace NanoXLSX
{
    ...
    public struct Address : IEquatable<Address>, IComparable<Address>
    {
        ...
        /// </summary>
        /// <remarks>This operator uses the <see cref="Address.Equals(Address)"/> method to determine
        /// equality.</remarks>
        ...
        /// <returns><see langword="true"/> if the two <see cref="Address"/> instances are equal; otherwise, <see
