...
{
    /// <summary>
    /// Interface, used by base plug-ins that are not handling a stream, but data in <see cref="IPluginReader.Workbook"/>
    /// </summary>
    internal interface IPluginProcessor : IPluginReader
    {
