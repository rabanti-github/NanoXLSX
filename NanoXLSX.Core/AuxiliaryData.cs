...
namespace NanoXLSX
{
    ...
    internal class AuxiliaryData
    {
        ...
        /// <param name="persistent">Optional parameter that indicates whether the set data is persistent (true) or temporary, just valid during the reading  or writing process (false = default)</param>
        ...
        /// <param name="valueId">ID of the value (e.g. cell address in a worksheet)</param>
        /// <param name="value">Generic value</param>
        /// <param name="persistent">Optional parameter that indicates whether the set data is persistent (true) or temporary, just valid during the reading  or writing process (false = default)</param>        /// \remark <remarks>The entity ID - which is neglected in this method - is automatically set to the value <see cref="DEFAULT_ENTITY_ID"/> (empty)</remarks>
