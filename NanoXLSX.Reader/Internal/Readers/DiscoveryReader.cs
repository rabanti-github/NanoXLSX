...
namespace NanoXLSX.Internal.Readers
{
    ...
    public class DiscoveryReader : IDiscoveryReader
    {
        ...
        /// </summary>
        /// <exception cref="IOException">Thrown on errors during the initialization or when invalid relationship data is encountered in strict validation mode.</exception>
        public void Execute()
        {
            if (archive == null)
            {
                throw new IOException("The discovery reader was not initialized with a ZIP archive.");
            }
            if (Workbook == null)
            {
                throw new IOException("The discovery reader was not initialized with a workbook.");
            }
        ...
        /// <summary>
        /// Executes the actual discovery of documents within the XLSX file. In case of errors, the issues are collected in <see cref="RelationshipCatalog.Issues"/>
        /// </summary>
        /// <returns>Catalog of discovered relationships</returns>
        ...
        /// <summary>
        /// Collects the information about a discovered relationship in an archive entry
        /// </summary>
        /// <param name="entry">Entry of the archive</param>
        /// <param name="sourcePartPath">Source part path URI</param>
        /// <param name="catalog">Catalog reference</param>
        /// <exception cref="IOException">May throw an IOException if the ReaderOptions have strict validation enabled</exception>
            ...
            try
            {
                ...
                using (XmlReader reader = XmlReader.Create(stream, XmlStreamUtils.CreateSettings()))
                {
                    ...
                    while (reader.Read())
                    {
                        ...
                        if (relationship == null) // Error case (issues are collected, skip)
                        {
                            continue;
                        }
                        if (!relationshipIds.Add(relationship.Id))
                        {
                            ...
                            {
                                throw CreateDiscoveryException(entry.FullName, relationship.Id, reason, null); // Results in a IOException
                            }
        ...
        /// <summary>
        /// Resolves the relevant attributes from a relationship entry, provided by a XML reader
        /// </summary>
        /// <param name="reader">Reader instance</param>
        /// <param name="relationshipPartPath"></param>
        /// <param name="sourcePartPath"></param>
        ...
        /// <summary>
        /// Handles issues, occurred during the discovery of relationships
        /// </summary>
        /// <param name="relationshipPartPath">Affected part path URI</param>
        /// <param name="relationshipId">rId of the affected relationship</param>
        /// <param name="reason">Error message</param>
        /// <param name="issues">Issue catalog reference</param>
        /// <param name="innerException">Inner exception (can be null)</param>
        /// <returns>Dummy return (will always return null)</returns>
        ...
        /// <summary>
        /// Handles issues of a package part, occurred during the discovery of relationships
        /// </summary>
        /// <param name="catalog">Catalog reference</param>
        /// <param name="relationshipPartPath">Affected part path URI</param>
        /// <param name="reason">Error message</param>
        ...
        /// <summary>
        /// Validates the provided XML attributes of a relationship entry
        /// </summary>
        /// <param name="id">rId attribute</param>
        /// <param name="type">Type attribute</param>
        /// <param name="target">Target URI attribute</param>
        /// <returns>Null, if all attributes are valid, otherwise the error message with the issue</returns>
        ...
        /// <summary>
        /// Identifies a .rels file in a package path URI 
        /// </summary>
        /// <param name="path">path URI to check</param>
        /// <returns>True, if a potential .rels file was identified</returns>
        ...
        /// <summary>
        /// Tries to create a source part URI
        /// </summary>
        /// <param name="relationshipPartPath">Name of the relative entry in the archive</param>
        /// <param name="sourcePartPath">Determined source part path URI as out parameter</param>
        /// <param name="error">Error message as out parameter. Null on success</param>
        /// <returns>Returns true on success, otherwise false (sets an error messsage)</returns>
        ...
        /// <summary>
        /// Creates a detailed IOException with relevant data to the discovery error
        /// </summary>
        /// <param name="relationshipPartPath">Affected relationship part</param>
        /// <param name="relationshipId">Affedcte rId</param>
        /// <param name="reason">Error message</param>
        /// <param name="innerException">Inner exception (can be null)</param>
        /// <returns>Formatted IOException</returns>
        ...
        /// <summary>
        /// Determines whether ReaderOptions have strict validation enabled. In this case, exceptions may be raised
        /// </summary>
        /// <returns>True if strict validation is enabled</returns>
