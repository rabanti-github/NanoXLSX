...
namespace NanoXLSX.Registry
{
    ...
    public static class PackageRegistry
    {
        ...
        private static Dictionary<string, Action<IWorkbook>> writerPrePlugins = new Dictionary<string, Action<IWorkbook>>();
        private static Dictionary<string, Action<IWorkbook>> writerPostPlugins = new Dictionary<string, Action<IWorkbook>>();
