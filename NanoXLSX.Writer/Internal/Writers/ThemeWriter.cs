...
namespace NanoXLSX.Internal.Writers
{
    ...
    internal class ThemeWriter : IPlugInWriter
    {
        ...
        public void Execute()
        {
            ...
            XmlElement = XmlElement.CreateElement("theme", "a");
            XmlElement.AddNameSpaceAttribute("a", "xmlns", "http://schemas.openxmlformats.org/drawingml/2006/main");
            XmlElement.AddAttribute("name", XmlUtils.SanitizeXmlValue(workbookTheme.Name));
            XmlElement themeElements = XmlElement.AddChildElement("themeElements", "a");
